...
-- Find the app that has the highest proportion of min_installs to reviews, among apps
-- that have been installed at least 100,000 times. Display the name of the app along with
-- the number of reviews, the min_installs, and the proportion. --
SELECT app_name, reviews, min_installs, CAST(reviews AS FLOAT)/min_installs AS ratio
FROM analytics
